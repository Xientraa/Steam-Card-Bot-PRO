...
function initialize() {
    ...
    console.log(
        `        (((((((((((   (((((    /((((((((((      888   d88P .d88b. 888888888 .d88b.  .d88b. 888  888  888`
            .cyan,
    );
    console.log(
        `        ((((((((((.  (      ((((((((((((((      8888888P" d8P  Y8b888   888d88""88bd88""88b888  888  888`
            .cyan,
    );
    console.log(
        `        ((((((((((   %%%%%     (((((((((((      888 T88b  88888888888   888888  888888  888888  888  888`
            .cyan,
    );
    console.log(
        `        (((((((%%%   %%%%%%%%*     (((((((      888  T88b Y8b.    888   888Y88..88PY88..88PY88b 888 d88P`
            .cyan,
    );
    console.log(
        `        (((#%%%%%%%  %%%%%%%%%%%%   %%%(((      888   T88b "Y8888 888   888 "Y88P"  "Y88P"  "Y8888888P"`
            .cyan,
    );
    console.log(
        `        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%.       888   T88b "Y8888 888   888 "Y88P"  "Y88P"  "Y8888888P"`
    ...
    console.log(
        "        This software has been developed by Veljko Vuckovic at - Refloow and published for free at GitHub.org"
            .cyan,
    );
    console.log(
        "                           Code origin: https://github.com/Refloow/Steam-Card-Bot-PRO"
    ...
    console.log(
        "      Official version of the bot is FREE with security updates only! Due economic situation and lack of support\n         newer versions can be purchased on our official discord server: https://discord.gg/XZtwJ4WW6T",
    );
    console.log(
        "                               ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀\n"
            .red,
...
function resume() {
    ...
    console.log(
        "If you are running app for the first time wait a bit for app to initialize.\n\n"
            .cyan,
    );
