 ...
 */
    ...
    STEAM_SUPPLY_API_KEY: "", // Bot API Key for Steam.supply
    ...
    TF2KEY: ["Mann Co. Supply Crate Key"],

    HYDRAKEY: ["Operation Hydra Case Key"],
    ...
    SELLHELP:
        "You are also able to sell sets. You can do this by using !sell [amount of keys].", // sellhelp command message
    ...
    REMOVEDINACTIVE:
        "Im cleaning my friendlist and removing inactive friends, please if you will use our service again re add me thanks.", // This message shows when user get cleared from friendlist.
